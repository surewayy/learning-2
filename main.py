...
class QuizScreen2(Screen):
    ...
    questions = [
        {
            "question": "1. Express eighty three million,\neight hundred and thirteen in figures",
            "options": ["80380013", "83800013", "8300013", "800380013"], "correct_answer": 0},
        {"question": "2. Covert DXIV to Arabic numerals",
         "options": ["545", "514", "404", "245"], "correct_answer": 0},
        {"question": "3. Divide 625.75 by 5",
         "options": ["125.15", "121.55", "15.15", "109.5"], "correct_answer": 0},
        {"question": "4. Find the H.C.F of 13 and 19", "options": ["64", "3", "13", "33"],
         "correct_answer": 2},
